...
class PolicyNetwork(nn.Module):
    def __init__(self, observation_space, n_actions):
        ...
        inpout_size = np.prod(self.input_dims)

        self.fc1 = nn.Linear(inpout_size, 128)
        # self.droupout1 = nn.Dropout(0.6)
        self.fc2 = nn.Linear(128, 128)
        # self.droupout2 = nn.Dropout(0.6)
...
def play_reinforce(env, model_path):
